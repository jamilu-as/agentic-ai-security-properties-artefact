...
**→ [START-HERE.md](START-HERE.md)** for current state, what to do next, and where things are.

Layout, rules, the check suite and the reviewer agents are all documented there. This file
states what the project is; that one states what to do.
