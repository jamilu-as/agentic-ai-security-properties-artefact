...
about composition; it is a within-axis replication, and Section 3.9 already records that
...
**Yes — verified in code, and this matters because Section 3.4 claims the attack-aware
...
defence's source or weights, which is why Section 3.4 places this at the attack-aware
tier and not the architecture-aware one — the distinction is stated in Section 2.4's four
...
they would be an unreliable baseline even if the quantities matched. Section 3.3 records
