...
Cut-points are those fixed in preregistration/PREREGISTRATION.md Section 9 and are not
...
# --- Cut-points, from PREREGISTRATION.md Section 9. Do not edit without re-locking. ---
CUTS = {
...
def decide(p: Profile, adv: Adversary) -> Decision:
    ...
    # Rule, from PREREGISTRATION.md Section 9. Order matters: avoid is checked first
